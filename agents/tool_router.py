...
def route_tool(question):
    ...
    # -------------------
        ...
        return {
            ...
            "answer":
            medicine_info(medicine_name)["answer"],
    ...
    # -------------------
        ...
        return {
            ...
            "answer":
            symptom_checker(question)["answer"],
    ...
    # -------------------
        ...
        return {
            ...
            "answer":
            prevention_tool(question)["answer"],
    ...
    # -------------------
        ...
        return {
            ...
            "answer":
            nutrition_tool(question)["answer"],
